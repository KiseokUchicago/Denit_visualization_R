...
```{r}
df_pH1_6.66 <- openxlsx::read.xlsx("data/220125_pH_colorimetric_pH1_using6.66.xlsx")  # this is using pH 6.66 to get mu_opt for every time point (pH of the 0 acid/base added sample may not stay at pH 6.66)
df_pH2_6.66 <- openxlsx::read.xlsx("data/220125_pH_colorimetric_pH2_using6.66.xlsx") # this is using pH 6.66 to get mu_opt for every time point (pH of the 0 acid/base added sample may not stay at pH 6.66)
