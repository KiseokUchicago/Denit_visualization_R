---
title: "220613_TOC_biomass_chloroform3_different_scale"
...
Experiment Date: 6/13/22 \
Analysis Date: 6/17/22 \
Lab: **Seppe Kuehn**
...
# import file
# 20ul
df_20ul_1 <- openxlsx::read.xlsx("data/220613_TOC_sample_plate1.xlsx")
# df_20ul_2 <- openxlsx::read.xlsx("data/220613_TOC_sample_plate2.xlsx")
# df_20ul_3 <- openxlsx::read.xlsx("data/220613_TOC_sample_plate3.xlsx")
...
# plot all
ggplot(df_plot, aes(x=Sample_type, y=TOC_mgml, color=Sample_type, group=Sample_type)) +
  ...
  ggtitle("Direct chloroform application method to soil \n") +
  # label
...
# plot all
ggplot(df_plot, aes(x=Sample_type, y=TOC_mgml, color=Chloroform, group=Chloroform)) +
  geom_point(size=3, shape=16) +
  # geom_line(size=1.2)+
  # geom_errorbar(aes(ymin=NO3_mM - Std_NO3_mM, ymax=NO3_mM + Std_NO3_mM), width=.05)+
  # scale_colour_gradientn(colours = col_pH(100)) +
...
# average
df_ave <- df_plot %>% group_by(Sample_type, Chloroform, Filtered) %>% summarize(std_mgml = sd(TOC_mgml), TOC_mgml = mean(TOC_mgml))
dim(df_ave)

ggplot(df_ave, aes(x=Sample_type, y=TOC_mgml, color=Chloroform, group=Chloroform)) +
  geom_point(size=3, shape=16) +
  # geom_line(size=1.2)+
