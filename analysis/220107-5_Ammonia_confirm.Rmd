---
title: "220107-5_Ammonia_confirm"
...
## 220107-5 Salicylate-hypochlorite Ammonia assay measurements
Researcher: **Kiseok Lee** \
Experiment Date: 1/7/22 \
Analysis Date: 1/7/22 \
Lab: **Seppe Kuehn** \
Motivation: Confirming with new soil sample (10ul sampling, 30min 37C) \
...
```{r}
# import file
df_am <- openxlsx::read.xlsx("data/220107-5_Ammonia_sample_plate1.xlsx")
dim(df_am)
...
## 220107-6 Left at 50min RT with the same plate as 220107-5

## 1. Import data table from python code
```{r}
# import file
df_am <- openxlsx::read.xlsx("data/220107-6_Ammonia_sample_plate1.xlsx")
dim(df_am)
...
## 220107-7 Fast reagent adding (<30s), 50 min at 25C RT

- same plate as 220107-5

## 1. Import data table from python code
```{r}
# import file
df_am <- openxlsx::read.xlsx("data/220107-7_Ammonia_sample_plate1.xlsx")
dim(df_am)
...
## 220107-8 Fast reagent adding (<30s), 15 min at 37C
...
```{r}
# import file
df_am <- openxlsx::read.xlsx("data/220107-8_Ammonia_sample_plate1.xlsx")
dim(df_am)
...
## 220107-9 Fast reagent adding (<30s), 5ul 30 min at 37C
- same plate as 220107-5

## 1. Import data table from python code
```{r}
# import file
df_am <- openxlsx::read.xlsx("data/220107-9_Ammonia_sample_plate1.xlsx")
dim(df_am)
